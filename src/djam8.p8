...
function drawstarbg()
	-- adjust the parallax factor to control the speed of the stars relative to the camera
	...
	-- draw the stars with the parallax offset
	for i,star in ipairs(stars) do
		local star_x = star.x - offset_x
		local star_y = star.y - offset_y
		
		-- handle wrapping of stars to keep them within the visible screen area
